...
final class BigCake {
  ...
  static <R extends Router> R createRouter(R router, Class<? extends BigCakePresenter> actualClass) {
    return createProxy(router, BigCakePresenter.class, actualClass, 1);
  }
